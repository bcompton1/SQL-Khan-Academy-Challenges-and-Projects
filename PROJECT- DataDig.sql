...
body TEXT, mean_radius NUMERIC, mean_radius_rel NUMERIC, volume NUMERIC, volume_rel NUMERIC, mass NUMERIC, mass_rel NUMERIC, density NUMERIC, surface_gravity NUMERIC, surface_gravity_rel NUMERIC, type_of_object TEXT, shape TEXT);
...
SELECT body FROM solar_system_objects WHERE type_of_object LIKE "%planets%" AND type_of_object;
